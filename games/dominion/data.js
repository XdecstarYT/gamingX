...
const TECHS = [
  ...
  // Military
  { id: 'standing_army', name: 'Standing Army', cat: 'Military', cost: 90, prereq: [], desc: 'Unlocks Infantry.' },
  { id: 'horsemanship', name: 'Horsemanship', cat: 'Military', cost: 120, prereq: [], desc: 'Unlocks Cavalry.' },
  { id: 'gunpowder', name: 'Gunpowder', cat: 'Military', cost: 220, prereq: ['standing_army'], desc: 'Unlocks Artillery.' },
  { id: 'motorization', name: 'Motorization', cat: 'Military', cost: 340, prereq: ['gunpowder'], desc: 'Unlocks Armor.' },
  { id: 'aviation', name: 'Aviation', cat: 'Military', cost: 480, prereq: ['motorization'], desc: 'Unlocks Aircraft.' },
  { id: 'fortification', name: 'Fortification', cat: 'Military', cost: 160, prereq: [], desc: '+15% defense power nationwide.', bonus: { defMult: 1.15 } },
  { id: 'rapid_deployment', name: 'Rapid Deployment', cat: 'Military', cost: 200, prereq: ['standing_army'], desc: '-20% unit training time nationwide.', bonus: { trainTimeMult: 0.8 } },
];
const TECHS_BY_ID = Object.fromEntries(TECHS.map(t => [t.id, t]));
const TECH_CATEGORIES = ['Energy', 'Construction', 'Agriculture', 'Medicine', 'Manufacturing', 'Computing', 'Military'];

/* ------------------------------------------------------------------ */
/* Military units — trained nationally (at a built Military Base),     */
/* garrisoned as a single national pool. Combat is instant-resolution: */
/* commit a share of the garrison to attack an adjacent enemy tile.    */
/* ------------------------------------------------------------------ */
const UNITS = [
  { id: 'militia', name: 'Militia', icon: '🔪', cost: 600, upkeep: 4, attack: 3, defense: 4, trainTicks: 3,
    desc: 'Cheap levy troops. Weak but available from turn one.' },
  { id: 'infantry', name: 'Infantry', icon: '🪖', cost: 1400, upkeep: 9, attack: 7, defense: 8, trainTicks: 5,
    needsTech: 'standing_army', desc: 'Well-drilled regulars — the backbone of any army.' },
  { id: 'cavalry', name: 'Cavalry', icon: '🐎', cost: 1800, upkeep: 11, attack: 11, defense: 6, trainTicks: 6,
    needsTech: 'horsemanship', desc: 'Fast strikers — high attack, fragile on defense.' },
  { id: 'artillery', name: 'Artillery', icon: '💣', cost: 2600, upkeep: 14, attack: 16, defense: 5, trainTicks: 7,
    needsTech: 'gunpowder', desc: 'Heavy guns. Devastating offense, poor defense.' },
  { id: 'armor', name: 'Armor', icon: '🛡️', cost: 3800, upkeep: 20, attack: 20, defense: 18, trainTicks: 9,
    needsTech: 'motorization', desc: 'Armored columns — strong on both sides of the line.' },
  { id: 'aircraft', name: 'Aircraft', icon: '✈️', cost: 4600, upkeep: 24, attack: 26, defense: 10, trainTicks: 11,
    needsTech: 'aviation', desc: 'Elite air power — the strongest attack in the game.' },
];
...
const ACHIEVEMENTS = [
  ...
  { id: 'first_conquest', name: 'First Conquest', icon: '⚔️', desc: 'Capture territory from a rival nation.', check: s => (s.war && s.war.tilesCaptured || 0) >= 1 },
  { id: 'conqueror', name: 'Conqueror', icon: '🏴', desc: 'Capture 25 tiles from rival nations.', check: s => (s.war && s.war.tilesCaptured || 0) >= 25 },
  { id: 'world_dominator', name: 'World Dominator', icon: '🌍', desc: 'Eliminate a rival nation entirely.', check: s => s.nations.some(n => n.eliminated) },
  { id: 'grand_army', name: 'Grand Army', icon: '🎖️', desc: 'Field 50 units at once.', check: s => Object.values(s.garrison || {}).reduce((a, b) => a + b, 0) >= 50 },
];
